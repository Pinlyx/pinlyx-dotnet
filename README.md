...
[![CI](https://github.com/Pinlyx/pinlyx-dotnet/actions/workflows/ci.yml/badge.svg)](https://github.com/Pinlyx/pinlyx-dotnet/actions/workflows/ci.yml)
...
```sh
git clone https://github.com/Pinlyx/pinlyx-dotnet.git
cd pinlyx-dotnet
dotnet test
```
